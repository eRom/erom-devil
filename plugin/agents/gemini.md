...
- succès : `{"devil":"gemini","model":"Gemini 3.7 Flash (High)","status":"ok","review":{…}}`
- échec  : `{"devil":"gemini","model":"Gemini 3.7 Flash (High)","status":"error","error":"CLI_FAILED|PARSE_ERROR|SCHEMA_INVALID|TIMEOUT","detail":"≤ 500 chars"}`
...
agy --dangerously-skip-permissions \
  ...
  --model 'Gemini 3.7 Flash (High)' --print-timeout 8m \
